...
const EditarProducto = () => {
    ...
    useEffect(() => {
        const fetchProducto = async () => {
            try {
                const response = await axios.get(`${process.env.REACT_APP_BACKEND_URL}/productos/${id}`);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await axios.put(`${process.env.REACT_APP_BACKEND_URL}/productos/${id}`, updatedFormData);
            Swal.fire({
                icon: 'success',
                title: 'Actualizado',
